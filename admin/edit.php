...
?>
    ...
    <form method="post" action="update.php" onsubmit="return valid()">
            <table style="margin-left: 30px;" class="reg-form">
                <input type="hidden" name="id" value='<?php echo "$id"?>'>
                <tr>
                    <td> <label for="">User Name</label></td>
                    <td>:</td>
                    <td> <input type="text" placeholder="User Name " id="username" name="user_name" value='<?php echo "$username" ?>'></td>
                </tr>
                <tr>
                    <td><label for="">Email</label></td>
                    <td>:</td>
                    <td><input type="text" placeholder="Email " id="email" name="email" value='<?php echo "$email" ?>'></td>
                </tr>
                <tr>
                    <td><label for="">Password </label></td>
                    <td>:</td>
                    <td><input type="text" placeholder="Password" id="password" name="password" value='<?php echo "$password" ?>'></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>:</td>
                    <td> <select name="country" id="country" name="country" value='<?php echo "$country" ?>'>
